        ...
        <div className="form">
          <Switch>
            <Route exact path="/quiz/question_1">
              <form action='/question_1' method='POST'>
            ...
            <Route exact path="/quiz/question_2">
                <form action='/question_2' method='POST'>
              ...
              <Route exact path="/quiz/question_4">
                <form action='/question_4' method='POST'>
              ...
              <Route exact path="/quiz/question_5">
                <form action='/question_5' method='POST'>
              ...
              <Route exact path="/quiz/question_6">
                <form action='/question_6' method='POST'>
              ...
              <Route exact path="/quiz/question_9">
                <form action='/question_9' method='POST'>
              ...
              <Route exact path="/quiz/question_10">
                <form action='/question_10' method='POST'>
